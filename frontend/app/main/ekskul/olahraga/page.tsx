...
export default function OlahragaPage() {
  const data = {
    ...
    image: "https://images.unsplash.com/photo-1575052814086-c71a72209a26?q=80&w=1920&auto=format&fit=crop",
    content: "Temukan potensimu di berbagai cabang olahraga populer lainnya seperti basket, voli, dan futsal. Kami membina bakat atletik siswa secara menyeluruh.",
    schedule: "Senin & Kamis, 15:30 - 17:30",
    coach: "Bpk. Bambang, S.Pd.",
  };
              ...
              <div className="p-10 rounded-[40px] bg-slate-900 text-white space-y-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-400 max-w-2xl leading-relaxed">
                    Tim olahraga SMAN 1 Bangunrejo rutin menjuarai berbagai kompetisi antar sekolah di tingkat daerah.
                  </p>
                </div>
              </div>
            </RevealOnScroll>
