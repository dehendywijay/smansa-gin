...
export default function KIRPage() {
  const data = {
    ...
    image: "https://images.unsplash.com/photo-1532187643623-dbf2f5a7d8bd?q=80&w=1920&auto=format&fit=crop",
    content: "Bagi kamu yang suka riset dan inovasi, KIR adalah tempat yang tepat untuk berkarya. Kami mengeksplorasi ilmu pengetahuan melalui penelitian yang menarik dan aplikatif.",
              ...
              <div className="p-10 rounded-[40px] bg-slate-900 text-white space-y-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-400 max-w-2xl leading-relaxed">
                    Karya ilmiah siswa SMAN 1 Bangunrejo telah memenangkan berbagai kompetisi riset remaja tingkat regional.
                  </p>
                </div>
              </div>
            </RevealOnScroll>
