...
if (!news) return <p>Loading...</p>;
  return (
    <Link href={`/main/berita/${news.slug}`} className="relative block w-full h-105 overflow-hidden shadow-lg cursor-pointer" onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
      {!hover ? (
